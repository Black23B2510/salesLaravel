        ...
        <div class="container">
            ...
            <div class="pull-right auto-width-right">
                <ul class="top-details menu-beta l-inline">
                    @if(Session::has('user'))
                    <li><a href="/userBills"><i class="fa fa-user"></i>{{ Session('user')->full_name }}</a></li>
                    ...
                    <div class="cart">
                        ...
                        <div class="beta-dropdown cart-body">
                            ...
                            <div class="cart-item" id="cart-item{{$product['item']['id']}}">
                                <a class="cart-item-delete" href="{{route('xoasp',$product['item']['id'])}}"
                ...
                <div class="beta-comp">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenuButton"
                            ...
                            (@if(isset($wishlists)&&count($wishlists)>0){{$sumWishlist}}@else
                            Trống @endif)
                        </button>
